...
Since version 2.5, bibliography entries are also scanned to check if some
entries are not explicitly cited in the text. In this case, a ``remove
bibitem'' message is printed.
\begin{verbatim}
****************************
